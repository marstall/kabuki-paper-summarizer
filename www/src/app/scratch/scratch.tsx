...
//         label: "Gene symbol",
//         value: "KMT2D",
//         note: "Current approved symbol; older papers often say MLL2."
//     },
//     {
//         label: "Full name",
//         value: "Lysine methyltransferase 2D",
//         note: "A gene encoding a histone-modifying enzyme."
//     },
//     {
//         label: "Gene type",
//         value: "Protein-coding",
//         note: "It carries instructions for a large KMT2D protein."
//     },
//     {
//         label: "Chromosome address",
//         value: "12q13.12",
//         note: "A cytogenetic neighborhood on chromosome 12."
//     },
//     {
//         label: "GRCh38 position",
//         value: "chr12:49,018,975–49,060,794",
//         note: "About 41.8 kb in the current human genome assembly."
//     },
//     {
//         label: "Strand",
//         value: "Minus",
//         note: "The gene is read from the reverse DNA strand."
//     },
// ];
//
// const concepts = [
...
//                 <div>
//                     <h3 className="text-lg font-semibold text-slate-900">KMT2D
//                         protein: simplified domain map</h3>
//                     <p className="mt-1 text-sm text-slate-600">Click a module.
//                         Domain positions are conceptual, not a clinical variant
//                         map.</p>
//                 </div>
//                 <SourceLink href={deepLinks.domains}>verify domains</SourceLink>
//             </div>
//             <div
//                 className="relative h-20 rounded-xl border border-slate-300 bg-slate-50 p-3">
//                 <div
//                     className="absolute left-4 right-4 top-1/2 h-3 -translate-y-1/2 rounded-full bg-slate-300"/>
//                 {domains.map((d, i) => {
...
//                                 left: `${lefts[i]}%`,
//                                 width: `${widths[i]}%`,
//                                 background: selected === i ? bg : soft,
//                                 borderColor: bg,
//                                 color: selected === i ? "white" : palette.ink
//                             }}
//                         >
//                             {d.name}
//                         </button>
...
//                 >
//                     <div
//                         className="text-xs uppercase tracking-wide text-slate-500">{domains[selected].span}</div>
//                     <div
//                         className="mt-1 font-semibold text-slate-900">{domains[selected].name}</div>
...
//                 <h3 className="text-lg font-semibold text-slate-900">How KMT2D
//                     changes gene readiness</h3>
//                 <SourceLink href={deepLinks.function}>verify
//                     function</SourceLink>
//             </div>
...
//                         <div
//                             className="mb-3 flex h-12 items-center justify-center">
//                             {idx === 0 && <div
//                                 className="h-8 w-24 rounded-full border border-slate-500 bg-white">
//                                 <div
//                                     className="mx-auto mt-3 h-1 w-20 bg-slate-400"/>
//                             </div>}
//                             {idx === 1 && <div className="flex gap-2"><span
//                                 className="rounded-full border bg-white px-2 py-1 text-xs">H3K4</span><span
//                                 className="rounded-full border bg-white px-2 py-1 text-xs">CH₃</span>
//                             </div>}
//                             {idx === 2 &&
//                                 <div className="h-1 w-28 rounded bg-slate-400">
//                                     <div
//                                         className="h-1 w-12 rounded bg-slate-700"/>
//                                 </div>}
//                             {idx === 3 && <div
//                                 className="rounded-md border border-slate-500 bg-white px-4 py-2 text-xs font-semibold">gene
//                                 easier to read</div>}
//                         </div>
//                         <div
//                             className="text-xs font-semibold uppercase tracking-wide text-slate-500">Step {idx + 1}</div>
//                         <div
//                             className="mt-1 font-semibold text-slate-900">{step.title}</div>
...
//     return (
//         <div
//             className="min-h-screen bg-[#f6f7f8] px-4 py-6 text-slate-900 md:px-8">
...
//                             <div
//                                 className="mb-3 inline-flex items-center gap-2 rounded-full border border-slate-300 bg-slate-50 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-slate-600">
//                                 <Sparkles size={14}/> Kabuki parent learning
//                                 card
//                             </div>
//                             <h1 className="text-4xl font-semibold tracking-tight text-slate-950 md:text-6xl">KMT2D</h1>
//                             <p className="mt-3 text-xl text-slate-700">A dry,
//                                 source-linked guide to the gene most often
//                                 implicated in Kabuki syndrome type 1.</p>
//                             <p className="mt-4 max-w-2xl text-sm leading-6 text-slate-600">The
//                                 goal is not to reproduce GeneCards. It is to
//                                 convert the dense card into a parent-usable
//                                 mental model: where the gene is, what the
//                                 protein does, why chromatin matters, and where
//                                 to verify each claim.</p>
//                         </div>
//                         <div
//                             className="rounded-2xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-700 md:w-80">
//                             <div
//                                 className="mb-2 flex items-center gap-2 font-semibold text-slate-900">
//                                 <ShieldCheck size={18}/> Anti-hallucination
//                                 design
//                             </div>
//                             <p className="leading-6">Every major section
//                                 includes deep links back to GeneCards. Treat
//                                 this page as an interpretive layer, not a
//                                 substitute for the source card or genetic
//                                 counseling.</p>
//                             <div className="mt-4 flex flex-wrap gap-2">
//                                 <SourceLink href={deepLinks.top}>GeneCards
//                                     KMT2D</SourceLink>
//                                 <SourceLink
//                                     href={deepLinks.summaries}>summaries</SourceLink>
//                             </div>
//                         </div>
//                     </div>
//                 </header>
...
//                                         <div
//                                             className="text-xs uppercase tracking-wide text-slate-500">{item.label}</div>
//                                         <div
//                                             className="mt-1 font-semibold text-slate-900">{item.value}</div>
//                                         <div
//                                             className="mt-1 text-xs leading-5 text-slate-600">{item.note}</div>
//                                     </div>
//                                 ))}
//                             </div>
//                             <div className="mt-4 flex flex-wrap gap-2">
//                                 <SourceLink
//                                     href={deepLinks.aliases}>aliases</SourceLink>
//                                 <SourceLink
//                                     href={deepLinks.genomics}>genomics</SourceLink>
//                             </div>
//                         </section>
//
//                         <section
//                             className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
//                             <label
//                                 className="mb-2 flex items-center gap-2 text-sm font-semibold text-slate-900"><Search
//                                 size={16}/> Search this guide</label>
//                             <input
//                                 value={query}
...
//                                     >
//                                         <div
//                                             className="text-xs opacity-75">{s.label}</div>
//                                         <div
//                                             className="font-semibold">{s.title}</div>
//                                     </button>
//                                 ))}
//                             </div>
//                         </section>
...
//                                                     className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
//                                         <div
//                                             className="mb-4 flex h-10 w-10 items-center justify-center rounded-xl bg-slate-100 text-slate-700">
//                                             <Icon size={20}/></div>
//                                         <h2 className="text-lg font-semibold text-slate-900">{c.title}</h2>
//                                         <p className="mt-2 text-sm leading-6 text-slate-700">{c.plain}</p>
//                                         <details
//                                             className="mt-3 rounded-xl border border-slate-200 bg-slate-50 p-3 text-sm text-slate-600">
//                                             <summary
//                                                 className="cursor-pointer font-semibold text-slate-800">Scientific
//                                                 wording
//                                             </summary>
//                                             <p className="mt-2 leading-6">{c.scientific}</p>
//                                         </details>
//                                         <div className="mt-4"><SourceLink
//                                             href={c.link}>{c.linkText}</SourceLink>
//                                         </div>
//                                     </motion.article>
//                                 );
//                             })}
...
//                             <div
//                                 className="mb-4 flex items-center gap-2 text-xs font-semibold uppercase tracking-wide text-slate-500">
//                                 <MousePointer2 size={14}/> Selected lesson
//                             </div>
//                             <AnimatePresence mode="wait">
...
//                                             exit={{opacity: 0, y: -8}}>
//                                     <div
//                                         className="text-sm font-semibold text-slate-500">{active.label}</div>
...
//                                         {active.verify.map(([label, href]) =>
//                                             <SourceLink key={label}
//                                                         href={href}>verify: {label}</SourceLink>)}
//                                     </div>
//                                 </motion.div>
//                             </AnimatePresence>
//                         </motion.article>
...
//                             <DomainStrip selected={selectedDomain}
...
//                                         <Network size={14}/> Parent-oriented map
//                                     </div>
//                                     <h2 className="mt-1 text-2xl font-semibold text-slate-950">What
//                                         to learn next from the GeneCards
//                                         page</h2>
//                                 </div>
//                                 <SourceLink href={deepLinks.top}>open source
//                                     card</SourceLink>
//                             </div>
//                             <div className="grid gap-4 md:grid-cols-3">
//                                 <div
//                                     className="rounded-xl border border-slate-200 bg-slate-50 p-4">
//                                     <h3 className="font-semibold">If your
//                                         question is “what is this gene?”</h3>
//                                     <p className="mt-2 text-sm leading-6 text-slate-600">Start
//                                         with summaries, aliases, and function.
//                                         Learn that KMT2D is a
//                                         chromatin-regulating enzyme before
//                                         diving into variants.</p>
//                                     <div className="mt-3 flex flex-wrap gap-2">
//                                         <SourceLink
//                                             href={deepLinks.summaries}>summaries</SourceLink><SourceLink
//                                         href={deepLinks.function}>function</SourceLink>
//                                     </div>
//                                 </div>
//                                 <div
//                                     className="rounded-xl border border-slate-200 bg-slate-50 p-4">
//                                     <h3 className="font-semibold">If your
//                                         question is “where is my child’s
//                                         variant?”</h3>
//                                     <p className="mt-2 text-sm leading-6 text-slate-600">Use
//                                         transcripts, proteins, domains, and
//                                         variants, but avoid overinterpreting
//                                         without a genetics team. Transcript
//                                         choice can change numbering.</p>
//                                     <div className="mt-3 flex flex-wrap gap-2">
//                                         <SourceLink
//                                             href={deepLinks.transcripts}>transcripts</SourceLink><SourceLink
//                                         href={deepLinks.variants}>variants</SourceLink>
//                                     </div>
//                                 </div>
//                                 <div
//                                     className="rounded-xl border border-slate-200 bg-slate-50 p-4">
//                                     <h3 className="font-semibold">If your
//                                         question is “why so many body
//                                         systems?”</h3>
//                                     <p className="mt-2 text-sm leading-6 text-slate-600">Look
//                                         at expression, pathways, and disorders.
//                                         A regulatory gene can affect many
//                                         tissues because many developmental
//                                         programs depend on gene timing.</p>
//                                     <div className="mt-3 flex flex-wrap gap-2">
//                                         <SourceLink
//                                             href={deepLinks.expression}>expression</SourceLink><SourceLink
//                                         href={deepLinks.pathways}>pathways</SourceLink>
//                                     </div>
//                                 </div>
//                             </div>
//                         </section>
//
//                         <footer
//                             className="rounded-2xl border border-slate-200 bg-white p-5 text-sm leading-6 text-slate-600 shadow-sm">
//                             <div className="flex items-start gap-3"><BookOpen
//                                 className="mt-0.5" size={18}/><p><strong
//                                 className="text-slate-900">Reading
//                                 note:</strong> “histone methyltransferase”
//                                 sounds like a narrow biochemical label, but for
//                                 Kabuki it is the doorway into the larger idea:
//                                 chromatin regulation. KMT2D helps set the
//                                 accessibility landscape in which many other
//                                 genes operate.</p></div>
//                         </footer>
//                     </section>
//                 </main>
