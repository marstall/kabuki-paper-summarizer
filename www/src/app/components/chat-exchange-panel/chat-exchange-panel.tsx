      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
          <div style={{ display: 'flex' }}>
            <svg width="50" height="33" viewBox="0 0 18 12" fill="none">
          ...
          <div style={{ display: 'flex' }}>
            <svg width="48" height="33" viewBox="0 0 17 12" fill="none">
          ...
          <div style={{ display: 'flex', alignItems: 'center' }}>
            <svg width="75" height="36" viewBox="0 0 27 13" fill="none">
