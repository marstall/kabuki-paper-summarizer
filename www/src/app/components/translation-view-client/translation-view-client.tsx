        ...
        <article>
          <header className="article-header">
            ...
            <div className="byline"><p>This is an AI-generated plain-english version of the {article.year} article <span
              ...
              generated by by {llm.model} {llm.type}. Click on sentences to see the correlating passages from the
              original paper.
            </p>
            </div>
          </header>
          ...
          <AdminSection>
            ...
            <div><Link className='button is-primary' href={`/articles/${article.id}/attachments/${attachment.id}`}>edit
              attachment</Link></div>
          </AdminSection>
        </article>
      </div>
