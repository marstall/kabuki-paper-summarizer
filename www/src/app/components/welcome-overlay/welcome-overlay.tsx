...
//   const showOverlay = true;
    ...
    if (overlayState === 'undefined') return <div
        className={styles.blockerContainer}/>
        ...
        <div className={styles.content}>
            <div className={styles.innerContent}>
                <div className={'content'}>
                    ...
                    <p>
                        Welcome to <span style={{color: 'green'}}><b>The Kabuki Papers</b></span>,
                        a blog/newsletter focused on making the science behind
                        Kabuki Syndrome
                        more accessible to families.
                    </p>
                    <p>
                        I'll be regularly posting cool Kabuki-related scientific
                        papers, translated into plain English by AI.
                    </p>
            ...
            <div className={styles.formContainer}>
                <form
                    action="https://buttondown.com/api/emails/embed-subscribe/KabukiDadChris"
                    method="post"
                    onSubmit={() => {
                ...
                >
                    ...
                    <div style={{marginTop: '0.55rem'}}>
                        <input className={styles.subscribeButton} type="submit"
                               value="Subscribe"/>
                    </div>
                    <div style={{marginTop: '0.55rem'}}>
                        <button className={styles.notRightNowButton}
                                onClick={dismiss}>Not right now
                        </button>
                    </div>
                </form>
            </div>
