    ...
    return <article className={styles.superContainer}>
        <header className="article-header">
            <div className={styles.supertitle}
                 style={{fontSize: '14px', lineHeight: '0.5'}}>
            ...
            {showFirstAttachmentBelowHeadline && attachment &&
            ...
            <div className={styles.dateline}>Written
                by {translation.llms.model_family} AI. Edited by <a
                    href={'https://www.linkedin.com/in/chrismarstall/'}>KabukiDadChris</a>.
                Posted
                on {shortDate(translation.published_at)}.
            </div>
            {showFirstAttachmentBelowCreditLine && attachment &&
                <div className={styles.attachment}>
                    <Attachment article={article} attachment={attachment}
                                allowMaximize={false} showCaption={false}/>
                </div>}
