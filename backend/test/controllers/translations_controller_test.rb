...
class TranslationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create translation" do
    assert_difference("Translation.count") do
      post translations_url, params: { translation: { body: @translation.body, title: @translation.title } }
    end
  ...
  test "should update translation" do
    patch translation_url(@translation), params: { translation: { body: @translation.body, title: @translation.title } }
